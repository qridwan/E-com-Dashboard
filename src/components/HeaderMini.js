...
class HeaderMini extends Component {
    ...
    render() {
        return (
            ...
            <div className="nav2h">
                <Navbar className="mini-nav fixed-top bg-white text-dark" expand="md">
                    <Navbar.Toggle aria-controls="responsive-navbar-nav" onClick={this.MenuBarClickHandler} className="minibtn btn" >
                        <i className="fas fa-bars "></i>
                    </Navbar.Toggle>
                    <Link className="nav-link" style={{marginLeft:'100px'}}>
