...
class AdminList extends Component {
                        ...
                        <Fragment>
                            <div className="row">
                                <div className="col-md-12 col-sm-12 col-lg-12">
                                    <Link to={"/profile/"+record.id} className="btn btn-primary btn-sm col-md-4 col-lg-4 col-sm-6 m-1  ">
    ...
    componentDidMount() {
        ...
        if(token){
            ...
            Axios.post(AppUrl.adminList,myFormData,config)
                .then(res=>{
                ...
                <div className="content-wrapper">
                    <Tabs >
                        ...
                        <div className="col-md-12 col-12 mr-5 bg-white">
                            <TabList>
                                <Tab> Admin List </Tab>
                                <Tab>Cashier List</Tab>
                            </TabList>
                        </div>
                        <TabPanel>
                            {this.state.loading==true ? <Loading/> :
                                <div className="row m-3 bg-white pt-3">
                                    <p className="body-title">Admin</p>
