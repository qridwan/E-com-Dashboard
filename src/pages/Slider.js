...
class Slider extends Component {
                        ...
                        <Fragment>
                            <div className="row">
                                <div className="col-md-12 col-sm-12 col-lg-12">
                                    <Link to={"/slider/edit/"+record.id}  className="btn btn-primary btn-sm col-md-4 col-lg-4 col-sm-6 m-1  ">
    ...
    componentDidMount() {
        ...
        if(token){
            ...
            Axios.post(AppUrl.SliderList,myFormData,config)
                .then(res=>{
                    this.setState({records:res.data,loading:false})
                    console.log(res.data+"Slider List Data Get")
                })
                .catch(error=>{
                    console.log(error)
                })
    ...
    onDel(e){
        ...
        Axios.post(AppUrl.deleteSlider,formData)
            .then(res=>{
                ...
                <div className="content-wrapper">
                    <div className="col-md-4 col-12 p-3">
                        <Link to="/slider/create"
                              className="btn btn-dark btn-sm" style={{width:'120px',marginLeft:'5px'}}>Add Image</Link>
                    </div>
                    {this.state.loading==true ? <Loading/> :
                        <div className="row m-3 bg-white pt-3">
                            <p className="body-title">Slider Image</p>
