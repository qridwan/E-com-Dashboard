...
class PaymentEdit extends Component {
    ...
    componentDidMount() {
        ...
        if(token){
            ...
            Axios.post(AppUrl.onePayment,myFormData,config)
                .then(res=>{
                    console.log("Userdata "+res.data)
                    this.setState({image:res.data[0]['img'],bank:res.data[0]['bank'],acc:res.data[0]['acc'],des:res.data[0]['des'],loading:false})
                })
                .catch(error=>{
                    localStorage.clear()
                    console.log(error)
    ...
    FormSubmit(event){
        ...
        Axios.post(AppUrl.updatePayment, formData)
            .then(res=>{
                if(res.data.success){
    ...
    render() {
        return (
            <Fragment>
                <Header title="Bank account Update"/>
                    ...
                    <div className="row m-3  pt-3">
                        ...
                        <div className="col-md-8 col-12">
                            <div className="col-md-12 uprofile col-12 bg-white py-3 mt-2 table-responsive-sm mb-5 ">
                                <h5 className='text-center'>Edit Bank Account   </h5>
                                <br/>
                                {this.state.loading==true?<Loading/>:
                                    <form onSubmit={this.FormSubmit.bind(this)}>
                                        ...
                                        <div className="form-group row " style={{height:'200px', marginBottom:'150px'}}>
