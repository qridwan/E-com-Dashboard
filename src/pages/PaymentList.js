...
class PaymentList extends Component {
    constructor() {
        ...
        this.columns = [
            ...
            {key: "bank", text: "Bank Name"},
            {key: "acc", text: "Bank Account"},
            ...
            {key: "img", text: "Image",
                cell: record => {
                    return(
                        <Fragment>
                            {record.img?<img className="img-responsive" style={{height:'40px',width:'60px'}} src={AppUrl.photoUrl+record.img} />
                        ...
                        <Fragment>
                            <div className="row" style={{width:'130px'}}>
                                <div className="col-md-12 col-sm-12 col-lg-12">
                                    <Link to={"/payment/edit/"+record.id}  className="btn btn-primary btn-sm col-md-4 col-lg-4 col-sm-6 m-1  ">
    ...
    componentDidMount() {
        ...
        if(token){
            ...
            Axios.post(AppUrl.PaymentList,myFormData,config)
                .then(res=>{
                    this.setState({records:res.data,loading:false})
                    console.log(res.data+"Payment List Data Get")
                })
                .catch(error=>{
                    console.log(error)
                })
    ...
    onDel(e){
        ...
        Axios.post(AppUrl.deletePayment,formData)
            .then(res=>{
    ...
    render() {
        ...
        return (
            <Fragment>
                <Header title="Bank Account List"/>
                <div className="content-wrapper">
                    <div className="col-md-4 col-12 p-3">
                        <Link to="/payment/create"
                                className="btn btn-dark btn-sm" style={{width:'120px',marginLeft:'5px'}}>Add Bank</Link>
                    </div>
                    {this.state.loading==true ? <Loading/> :
                        <div className="row m-3 bg-white pt-3">
                            <p className="body-title">Payment Method</p>
