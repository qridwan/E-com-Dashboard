...
class EditMessage extends Component {
    ...
    componentDidMount() {
        ...
        if(token){
            ...
            Axios.post(AppUrl.oneMessage,myFormData,config)
                .then(res=>{
                    this.setState({title:res.data[0]['title'],des:res.data[0]['body'],uid:res.data[0]['uid'],
                        uname:res.data[0]['name'], type:res.data[0]['type'],loading:false})
                })
                .catch(error=>{
                    console.log(error)
                })
    ...
    FormSubmit(event){
        ...
        if(this.state.uid !=""){
            Axios.post(AppUrl.updateMessage, formData)
                .then(res=>{
                    if(res.data.success){
                    ...
                    <div className="row m-3  pt-3">
                        ...
                        <div className="col-md-8 col-12">
                            <div className="col-md-12 uprofile col-12 bg-white py-3 mt-2 table-responsive-sm mb-5 ">
                                <h5 className='text-center'>Edit Message  </h5>
                                <br/>
